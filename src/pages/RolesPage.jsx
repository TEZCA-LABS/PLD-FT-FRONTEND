...
import { RolesTable, RoleDetailsSidebar } from '@features/roles';
            ...
            <div className="flex flex-col gap-6">
                <div className="flex flex-wrap justify-between items-center gap-4">
                    <div className="flex flex-col gap-1">
                        <h2 className="text-[#111418] dark:text-white text-3xl font-black leading-tight tracking-tight">Gestión de Roles (Admin)</h2>
                        <p className="text-[#617289] dark:text-gray-400 text-sm font-normal">Control de acceso y políticas de seguridad para cumplimiento AML/CFT.</p>
                    </div>
