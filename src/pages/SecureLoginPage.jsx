...
const SecureLoginPage = () => {
    return (
        <div className="font-display bg-background-light dark:bg-background-dark min-h-screen flex flex-col overflow-x-hidden transition-colors duration-200">
            <div
                ...
                style={{
                    backgroundImage: 'linear-gradient(#1a427a 1px, transparent 1px), linear-gradient(90deg, #1a427a 1px, transparent 1px)',
            ...
            <div className="relative z-10 w-full px-6 py-4 flex justify-between items-center">
                <div className="flex items-center gap-2 opacity-60 hover:opacity-100 transition-opacity cursor-default">
                    <span className="material-symbols-outlined text-primary dark:text-blue-400 text-xl">shield_moon</span>
                ...
                <div className="flex items-center gap-2 bg-white dark:bg-slate-800 px-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-700 shadow-sm">
                    ...
                    <span className="text-xs font-medium text-slate-600 dark:text-slate-300">Sistema Operativo</span>
                </div>
            </div>
