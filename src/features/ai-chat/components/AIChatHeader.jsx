  ...
  return (
    <header className="h-16 flex items-center justify-between whitespace-nowrap border-b border-solid border-[#e2e8f0] dark:border-gray-700 bg-white dark:bg-[#1a232e] px-6 z-20 shadow-sm shrink-0">
      <div className="flex items-center gap-4 text-[#121417] dark:text-white">
        ...
        <div>
          <h2 className="text-[#121417] dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">
            Asistente de Cumplimiento IA
          </h2>
          <div className="flex items-center gap-1.5">
            <div className="size-2 rounded-full bg-green-500"></div>
            <span className="text-xs font-medium text-[#64748b] dark:text-gray-400">
              Sistema en línea • Modo confidencial activo
            </span>
          </div>
        </div>
      </div>
      <div className="flex items-center justify-end gap-4">
        ...
        <div className="flex gap-2">
          <button
            onClick={onToggleExportFormat}
            className="flex items-center justify-center rounded-lg h-9 px-3 bg-[#f8fafc] dark:bg-[#252f3d] hover:bg-slate-100 dark:hover:bg-slate-700 text-xs font-bold border border-[#e2e8f0] dark:border-gray-700"
            title="Cambiar formato de exportación"
          >
          ...
          >
            <span className="truncate">Exportar Caso</span>
          </button>
        ...
        <div
          className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-9 ring-2 ring-white shadow-sm"
          style={{
            backgroundImage:
              'url("https://lh3.googleusercontent.com/aida-public/AB6AXuDWtvMncb8HSxnRfgImmRglk2CnxvwL0UPhf3ktzGNcLijsum59C5SKiFgWajCif0MrHPhZQ37FdsMINMt4Ttu7QH6_CpjFC8OTaCDCch7Kz4ANm_Z21sGHmCViL5ibYRYxRMViWeqAL4TWf1ULqKx50rX40q1jZu5IHlYbYd6JbCeDWst52VXguVdF2_xqfWga1pZuJsqptfFKCw3fyVxa0m3HiKWXZfoDhTeaoa1X2iz5yr6Hoxt8jpgeGQs3Ha9kH5_M4j__Ajs")',
          }}
        ></div>
      </div>
    </header>
