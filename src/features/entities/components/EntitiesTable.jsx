...
export const EntitiesTable = () => {
  ...
  if (isLoading) {
    return (
      <div className="p-8 text-center text-gray-500">Cargando entidades...</div>
    );
  }
          ...
          <tbody className="divide-y divide-[#f0f2f4] dark:divide-[#2d3a4b]">
            {entities?.map((entity) => (
              ...
              >
                ...
                <td
                  className="px-6 py-4 text-sm text-[#617289] dark:text-[#a0aec0] max-w-xs truncate"
            ...
            {(!entities || entities.length === 0) && (
              <tr>
                <td
                  colSpan="4"
                  className="px-6 py-8 text-center text-sm text-[#617289] dark:text-[#a0aec0]"
                >
