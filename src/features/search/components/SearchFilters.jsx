        ...
        <div className="bg-white dark:bg-slate-850 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-5 flex flex-col gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="relative inline-block text-left">
                    <button className="inline-flex items-center gap-2 justify-center w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all" type="button">
                        <span className="material-symbols-outlined text-[18px] text-slate-400">database</span>
                        Todas las Fuentes
                        <span className="material-symbols-outlined text-[18px] text-slate-400 ml-1">expand_more</span>
                    </button>
                </div>
                <div className="relative inline-block text-left">
                    <button className="inline-flex items-center gap-2 justify-center w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all" type="button">
                ...
                <button className="text-sm text-primary hover:text-primary/80 font-medium px-2">Limpiar Todo</button>
            </div>
        </div>
    );
};
