  ...
  return (
    <div className="bg-white dark:bg-[#1a2432] rounded-xl shadow-sm border border-[#f0f2f4] dark:border-[#2d3a4b] overflow-hidden">
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-[#f8f9fa] dark:bg-[#243040]/50 border-b border-[#f0f2f4] dark:border-[#2d3a4b]">
              <th className="px-6 py-4 text-xs font-bold text-[#617289] dark:text-[#a0aec0] uppercase tracking-wider">
                Nombre
              </th>
              <th className="px-6 py-4 text-xs font-bold text-[#617289] dark:text-[#a0aec0] uppercase tracking-wider">
                Correo
              ...
              <th className="px-6 py-4 text-xs font-bold text-[#617289] dark:text-[#a0aec0] uppercase tracking-wider text-right">
                Acciones
              </th>
            </tr>
          </thead>
          <tbody className="divide-y divide-[#f0f2f4] dark:divide-[#2d3a4b]">
            {users?.map((user) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-[#617289] dark:text-[#a0aec0]">
                  {user.email}
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center gap-1.5">
                    <span
                      className={`size-2 rounded-full ${user.is_active ? 'bg-green-500' : 'bg-red-500'}`}
                    ></span>
                    <span
                      className={`text-sm font-medium ${user.is_active ? 'text-green-700 dark:text-green-400' : 'text-red-700 dark:text-red-400'}`}
                    >
      ...
      <div className="px-6 py-4 flex items-center justify-between border-t border-[#f0f2f4] dark:border-[#2d3a4b]">
        <p className="text-sm text-[#617289] dark:text-[#a0aec0]">
